...
class getMessenger_TransportFactoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport_factory'] = new \Symfony\Component\Messenger\Transport\TransportFactory(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['Koco\\Kafka\\Messenger\\KafkaTransportFactory'] ?? $container->load('getKafkaTransportFactoryService'));
            yield 4 => ($container->privates['Koco\\Kafka\\Messenger\\RestProxyTransportFactory'] ?? $container->load('getRestProxyTransportFactoryService'));
        }, 5));
    }
}
